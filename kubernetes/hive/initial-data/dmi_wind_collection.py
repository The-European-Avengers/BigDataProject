...
WIND_STATIONS = {
    "06154": "Brandelev", "06068": "Isenvad", "06082": "Borris", "06180": "KÃ¸benhavns Lufthavn",
    "06110": "Flyvestation Skrydstrup", "06120": "Odense Lufthavn", "06072": "Ã˜dum", "06031": "Tylstrup",
    "06060": "Flyvestation Karup", "06181": "JÃ¦gersborg", "06193": "Hammer Odde Fyr", "06188": "SjÃ¦lsmark",
    "06096": "RÃ¸mÃ¸/Juvre", "06108": "Kolding Lufthavn", "06069": "Foulum", "06147": "VindebÃ¦k Kyst",
    "06074": "Ã…rhus Syd", "06124": "Sydfyns Flyveplads", "06093": "Vester Vedsted", "06079": "Anholt Havn",
    "06058": "Hvide Sande", "06056": "Mejrup", "06116": "Store Jyndevad", "06118": "SÃ¸nderborg Lufthavn",
    "06081": "BlÃ¥vandshuk Fyr", "06138": "LangÃ¸", "06169": "Gniben", "06080": "Esbjerg Lufthavn",
    "06159": "RÃ¸snÃ¦s Fyr", "06032": "StenhÃ¸j", "06136": "Tystofte", "06168": "Nakkehoved Fyr",
    "06119": "KegnÃ¦s Fyr", "06104": "Billund Lufthavn", "06041": "Skagen Fyr", "06151": "OmÃ¸ Fyr",
    "06174": "TessebÃ¸lle", "06123": "Assens/TorÃ¸", "06013": "Klaksvik Heliport", "06135": "Flakkebjerg",
    "06141": "Abed", "06065": "Ã…rs Syd", "06197": "NexÃ¸ Vest", "06073": "Sletterhage Fyr",
    "06049": "Hald Vest", "06052": "ThyborÃ¸n", "06149": "Gedser", "06126": "Ã…rslev",
    "06170": "Roskilde Lufthavn", "06132": "Tranebjerg Ã˜st", "06156": "HolbÃ¦k", "06109": "Askov",
    "06070": "Ã…rhus Lufthavn", "06030": "Flyvestation Ã…lborg", "06102": "Horsens/Bygholm",
...
def save_data(data, year):
    """Save collected wind data to CSV in the shared volume."""
    if not data:
    ...
    filename = f"{SHARED_DATA_PATH}/{year}_dmi_wind.csv"
    df.to_csv(filename, index=False)
    
    print(f"\nSaved {len(df)} wind records to shared volume path: {filename}")
...
def main():
    ...
    for TARGET_YEAR in TARGET_YEARS:
        ...
        filename = f"{SHARED_DATA_PATH}/{TARGET_YEAR}_dmi_wind.csv"
        ...
        print(f"Time for {TARGET_YEAR}: {duration}")
